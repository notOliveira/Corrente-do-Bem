    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.IntegerField(choices=[(1, 'Alimentos'), (2, 'Eletrônicos'), (3, 'Vestuário'), (4, 'Mobílias'), (5, 'Leitura'), (6, 'Limpeza'), (7, 'Brinquedos'), (8, 'Utensílios'), (9, 'Voluntariado'), (10, 'Diversos')], unique=True)),
            ],
            options={
